...
if not args.skip_training:
  common_args = " --disable_viewer --quiet --evaluate --test_iterations -1 "
  ...
  for scene in mipnerf360_outdoor_scenes:
    ...
    os.system(
      "python train.py -s " + source + " -i images_4 -m " + args.output_path + "/" + scene + common_args
    )
  for scene in mipnerf360_indoor_scenes:
    source = args.mipnerf360 + "/" + scene
    os.system(
      "python train.py -s " + source + " -i images_2 -m " + args.output_path + "/" + scene + common_args
    )
...
if not args.skip_rendering:
  ...
  common_args = " --quiet --evaluate --skip_train"
